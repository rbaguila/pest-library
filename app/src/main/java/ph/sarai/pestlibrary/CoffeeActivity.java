 ...
 */
public class CoffeeActivity extends AppCompatActivity implements ItemAllAdapter.ClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coffeeAdapter = new ItemAllAdapter(this, new ItemData(this).getAllCoffeeItemData(), 1);
