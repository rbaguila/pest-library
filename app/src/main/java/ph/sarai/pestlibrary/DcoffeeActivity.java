 ...
 */
public class DcoffeeActivity extends AppCompatActivity implements ItemAllAdapter.ClickListener{

    private RecyclerView coffeeRecycler;
    private ItemAllAdapter coffeeAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dcoffee);
        ...
        coffeeRecycler = (RecyclerView) findViewById(R.id.pest_items_all);
        coffeeRecycler.setHasFixedSize(true);
        LinearLayoutManager coffeeLinearLayout = new LinearLayoutManager(this);
        coffeeLinearLayout.setOrientation(LinearLayoutManager.VERTICAL);
        coffeeRecycler.setLayoutManager(coffeeLinearLayout);
        coffeeAdapter = new ItemAllAdapter(this, new ItemData(this).getAllDcoffeeItemData(), 2);
        coffeeAdapter.setClickListener(this);
