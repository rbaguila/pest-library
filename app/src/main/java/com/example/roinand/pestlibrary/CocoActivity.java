 ...
 */
public class CocoActivity extends AppCompatActivity implements ItemAllAdapter.ClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cocoAdapter = new ItemAllAdapter(this, new ItemData(this).getAllCocoItemData(), 1);
